...
docker cp users.csv attractions-app-postgres_attractions-1:/tmp/
docker cp groups.csv attractions-app-postgres_attractions-1:/tmp/
docker cp attractions.csv attractions-app-postgres_attractions-1:/tmp/
